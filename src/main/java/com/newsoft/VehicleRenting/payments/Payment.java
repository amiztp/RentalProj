...
public abstract class Payment {
     ...
     */
    public Payment(String payerName, double amount, String vehicleReg, String nic, String paymentMethod) {
     ...
     * Format: id,payerName,amount,vehicleReg,nic,paymentMethod,timestamp
     * 
